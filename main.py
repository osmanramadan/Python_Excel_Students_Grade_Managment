...
#         self.Col4 = tk.StringVar()
#         self.Col5 = tk.StringVar()
#         self.Col6 = tk.StringVar()
#         self.Col7 = tk.StringVar()
#         self.Col8 = tk.StringVar()
#         self.Col9 = tk.StringVar()
#         self.Col10 = tk.StringVar()
#         self.Col11 = tk.StringVar()
#         self.Col12 = tk.StringVar()
#         self.Col13 = tk.StringVar()
#         self.Col14 = tk.StringVar()
#         self.Col15 = tk.StringVar()
#         self.Col16 = tk.StringVar()
#         self.Col17 = tk.StringVar()
#         self.delete = tk.StringVar()

#         # Create the UI components (entry fields, buttons, etc.)
#         self.create_widgets()
...
#         # Create and place your UI components here
#         # For example:
#         tk.Entry(self.root, textvariable=self.Col1).pack()
#         tk.Button(self.root, text="Add Student", command=self.add_student).pack()
#         tk.Button(self.root, text="Update", command=self.update).pack()
#         tk.Button(self.root, text="Delete", command=self.delete_id).pack()
        
#         # Set up the treeview
#         self.student_table = ttk.Treeview(self.root, columns=("Col1", "Col2", "Col3", "Col4", "Col5",
#                                                                "Col6", "Col7", "Col8", "Col9", "Col10",
#                                                                "Col11", "Col12", "Col13", "Col14", "Col15",
#                                                                "Col16", "Col17"), show="headings")
#         for col in self.student_table["columns"]:
#             self.student_table.heading(col, text=col)
#         self.student_table.pack()

#         # Create vertical scrollbar
#         self.yscroll = ttk.Scrollbar(self.student_table, orient="vertical", command=self.student_table.yview)
#         self.student_table.configure(yscrollcommand=self.yscroll.set)
        
#         # Create horizontal scrollbar
#         self.xscroll = ttk.Scrollbar(self.student_table, orient="horizontal", command=self.student_table.xview)
#         self.student_table.configure(xscrollcommand=self.xscroll.set)

#         # Pack the Treeview and the scrollbars
...
#             df = pd.read_excel('arbic.xlsx')  # Update with your Excel file path
            
#             if not df.empty:
#                 self.student_table.delete(*self.student_table.get_children())
#                 for index, row in df.iterrows():
#                     self.student_table.insert("", "end", values=row.tolist())
...
#                 "Col 8": self.Col8.get(),
#                 "Col 9": self.Col9.get(),
#                 "Col 10": self.Col10.get(),
#                 "Col 11": self.Col11.get(),
#                 "Col 12": self.Col12.get(),
#                 "Col 13": self.Col13.get(),
#                 "Col 14": self.Col14.get(),
#                 "Col 15": self.Col15.get(),
#                 "Col 16": self.Col16.get(),
#                 "Col 17": self.Col17.get(),
#             }
...
#             df.to_excel('arbic.xlsx', index=False)
...
#             student_id = self.Col16.get()  # Assuming this is the ID column
#             index = df[df['Col 16'] == student_id].index
...
#                 self.fetchelements()
#             else:
#                 messagebox.showinfo("Update Failed", "Student not found.")
#         except Exception as e:
...
#             student_id = self.delete.get()
#             df = df[df['Col 17'] != student_id]  # Filter out the student with the given ID
